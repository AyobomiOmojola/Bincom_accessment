    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uniquewardid', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, related_name='ward_polling', to='election_poll.ward')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_entered', models.DateTimeField(null=True)),
                ('user_ip_address', models.CharField(max_length=50)),
                ('state_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='state_lga', to='election_poll.states')),
            ],
            options={
                'db_table': 'lga',
            },
